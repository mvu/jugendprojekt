...
"color:rgb(255,255,255);"));
    ...
    {
        Theke->setWindowTitle(QApplication::translate("Theke", "Dialog", 0));
        label->setText(QApplication::translate("Theke", "Theke Licht", 0));
        pushButton_back->setText(QString());
        groupBox_RGB->setTitle(QApplication::translate("Theke", "RGB", 0));
        groupBox->setTitle(QString());
        pushButton_rgb_togge->setText(QApplication::translate("Theke", "An", 0));
        groupBox_2->setTitle(QString());
        pushButton_rgb_set->setText(QApplication::translate("Theke", "Farbe\n"
"einstellen", 0));
        groupBox_lampen->setTitle(QApplication::translate("Theke", "Deckenlampen", 0));
        groupBox_3->setTitle(QString());
        pushButton->setText(QApplication::translate("Theke", "An", 0));
    } // retranslateUi

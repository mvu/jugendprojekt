...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_pca_9635_t, stringdata) + ofs \
...
const QMetaObject pca_9635::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_pca_9635.data,
      qt_meta_data_pca_9635,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_pca_9635.stringdata))

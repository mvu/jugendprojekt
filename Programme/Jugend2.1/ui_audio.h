...
"color:rgb(250,250,250);"));
    ...
    {
        Audio->setWindowTitle(QApplication::translate("Audio", "Dialog", Q_NULLPTR));
        groupBox_2->setTitle(QApplication::translate("Audio", "Eingang", Q_NULLPTR));
        pushButtonPC->setText(QApplication::translate("Audio", "PC", Q_NULLPTR));
        pushButtonAUX->setText(QApplication::translate("Audio", "AUX", Q_NULLPTR));
        pushButtonPlaystation->setText(QApplication::translate("Audio", "PlayStation", Q_NULLPTR));
        label->setText(QApplication::translate("Audio", "Audio", Q_NULLPTR));
        groupBox_3->setTitle(QApplication::translate("Audio", "Lautst\303\244rke", Q_NULLPTR));
        pushButtonLautstaerke_Laut->setText(QApplication::translate("Audio", "Laut", Q_NULLPTR));
        pushButtonLautstaerke_Mittel->setText(QApplication::translate("Audio", "Mittel", Q_NULLPTR));
        pushButtonLautstaerke_Leise->setText(QApplication::translate("Audio", "Leise", Q_NULLPTR));
        pushButton_OnOff->setText(QApplication::translate("Audio", "An/Aus", Q_NULLPTR));
        pushButton_back->setText(QString());
        label_2->setText(QApplication::translate("Audio", "<html><head/><body><p><span style=\" font-size:9pt;\">Hinweis:</span><span style=\" font-size:9pt; font-style:italic;\"> Der Verst\303\244rker reagiert tr\303\244ge, bitte dementsprechend geduldig sein....</span></p></body></html>", Q_NULLPTR));
    } // retranslateUi

...
thread_Ueberwachung::thread_Ueberwachung(QObject *parent, steuerungThreadLicht *s, ModelThreadLicht *m)
{
    //setup on start
    ...
    */
    ...
    bool con = ArduinoUDP->connectUDP(1, ArduinoIp, ArduinoPort);
    checkTemp();

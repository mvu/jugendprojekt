...
"background-color:rgba(0,0,0,100);"));
    ...
    {
        RGB_Decke->setWindowTitle(QApplication::translate("RGB_Decke", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("RGB_Decke", "RGB Decke", Q_NULLPTR));
        label_2->setText(QApplication::translate("RGB_Decke", "Gruppe", Q_NULLPTR));
        pushButton_all->setText(QApplication::translate("RGB_Decke", "Alle", Q_NULLPTR));
        pushButton_Group_1->setText(QApplication::translate("RGB_Decke", "1", Q_NULLPTR));
        pushButton_Group_2->setText(QApplication::translate("RGB_Decke", "2", Q_NULLPTR));

/****************************************************************************
** Meta object code from reading C++ file 'modelthreadlicht.h'
**
...
#error "The header file 'modelthreadlicht.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ModelThreadLicht_t, stringdata) + ofs \
...
const QMetaObject ModelThreadLicht::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ModelThreadLicht.data,
      qt_meta_data_ModelThreadLicht,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ModelThreadLicht.stringdata))

...
"color:white;"));
    ...
    {
        Medien_auswahl->setWindowTitle(QApplication::translate("Medien_auswahl", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("Medien_auswahl", "Medien", Q_NULLPTR));
        pushButton_Audio->setText(QApplication::translate("Medien_auswahl", "Audio (noch deaktiviert)", Q_NULLPTR));
        pushButton_Beamer->setText(QApplication::translate("Medien_auswahl", "Beamer an", Q_NULLPTR));
        pushButton_PC->setText(QApplication::translate("Medien_auswahl", "PC an", Q_NULLPTR));
        label_uhr_2->setText(QApplication::translate("Medien_auswahl", "11:05", Q_NULLPTR));

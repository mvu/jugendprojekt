...
"color:rgb(0,0,0);"));
    ...
    {
        RgbWand->setWindowTitle(QApplication::translate("RgbWand", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("RgbWand", "RGB Fenster", Q_NULLPTR));
        pushButton_back->setText(QString());
        groupBox->setTitle(QString());
        groupBox_2->setTitle(QString());
        pushButton_toggle->setText(QApplication::translate("RgbWand", "An", Q_NULLPTR));

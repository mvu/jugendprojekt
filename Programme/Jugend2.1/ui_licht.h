...
"}"));
    ...
    {
        Licht->setWindowTitle(QApplication::translate("Licht", "Dialog", Q_NULLPTR));
        pushButtonHome->setText(QApplication::translate("Licht", "Home", Q_NULLPTR));
        pushButtonJugend->setText(QApplication::translate("Licht", "Jugend On", Q_NULLPTR));
        pushButtonTeenkreis->setText(QApplication::translate("Licht", "Teenkreis On", Q_NULLPTR));
        pushButtonPraisTime->setText(QApplication::translate("Licht", "Praise time", Q_NULLPTR));
        pushButtonEinstellung->setText(QApplication::translate("Licht", "Einstellung", Q_NULLPTR));
        pushButtonMovie->setText(QApplication::translate("Licht", "Movie", Q_NULLPTR));
        pushButtonLichtAus->setText(QApplication::translate("Licht", "Licht AUS", Q_NULLPTR));
    } // retranslateUi

/****************************************************************************
** Meta object code from reading C++ file 'MainVisu_palette.h'
**
...
#include "MainVisu_palette.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'MainVisu_palette.h' doesn't include <QObject>."
...
const QMetaObject Palette::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Palette.data,
      qt_meta_data_Palette,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};

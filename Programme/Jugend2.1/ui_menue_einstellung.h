...
public:
    ...
    {
        Menue_Einstellung->setWindowTitle(QApplication::translate("Menue_Einstellung", "Dialog", Q_NULLPTR));
        groupBox_hauptlicht->setTitle(QString());
        label_2->setText(QApplication::translate("Menue_Einstellung", "Hauptlicht", Q_NULLPTR));
        pushButton_hauptlicht_2->setText(QString());
        groupBox_RGBdecke->setTitle(QString());
        label_3->setText(QApplication::translate("Menue_Einstellung", "RGB Decke", Q_NULLPTR));
        pushButton_RGBdecke->setText(QString());
        groupBox_theke->setTitle(QString());
        label_4->setText(QApplication::translate("Menue_Einstellung", "Theke", Q_NULLPTR));
        pushButton_Theke_2->setText(QString());
        groupBox_RGBfenster->setTitle(QString());
        label_6->setText(QApplication::translate("Menue_Einstellung", "RGB Fenster", Q_NULLPTR));
        pushButton_RGBfenster->setText(QString());
        groupBox_palette->setTitle(QString());
        label_5->setText(QApplication::translate("Menue_Einstellung", "Paletten an", Q_NULLPTR));
        pushButton_palette->setText(QString());
        groupBox_save->setTitle(QString());
        label_7->setText(QApplication::translate("Menue_Einstellung", "Speichern", Q_NULLPTR));
        pushButton_save->setText(QString());
        groupBox_close->setTitle(QString());
        label_8->setText(QApplication::translate("Menue_Einstellung", "Schlie\303\237en", Q_NULLPTR));
        pushButton_close->setText(QString());
        label_uhr_2->setText(QApplication::translate("Menue_Einstellung", "11:05", Q_NULLPTR));
        label_9->setText(QApplication::translate("Menue_Einstellung", "Men\303\274", Q_NULLPTR));
    } // retranslateUi

...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RgbWand_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 106, 27),
QT_MOC_LITERAL(10, 134, 28),
...
const QMetaObject RgbWand::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_RgbWand.data,
      qt_meta_data_RgbWand,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RgbWand.stringdata))

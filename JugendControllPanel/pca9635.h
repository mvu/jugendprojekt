...
extern int pca9635Setup(const int i2cAddress/* = 0x40*/);
...
extern void pca9635PWMFreq(int fd, float freq);
extern void pca9635PWMReset(int fd);
extern void pca9635PWMWrite(int fd, int pin, int pwm);
extern void pca9635PWMRead(int fd, int reg);

extern void pca9635FullOn(int fd, int pin, int tf);
extern void pca9635FullOff(int fd, int pin, int tf);
//void pca9685Setup(int i2cAddress);
